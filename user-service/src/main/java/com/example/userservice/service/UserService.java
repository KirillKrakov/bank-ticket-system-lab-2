...
public class UserService {
    ...
    @Transactional
    public Mono<UserDto> update(UUID userId, UUID actorId, UserRequest req) {
    ...
    @Transactional
    public Mono<Void> delete(UUID userId, UUID actorId) {
        return validateAdmin(actorId)
                .then(userRepository.findById(userId))
                .switchIfEmpty(Mono.error(new NotFoundException("User not found: " + userId)))
                .flatMap(user -> {
    ...
    @Transactional
    public Mono<Void> promoteToManager(UUID userId, UUID actorId) {
        return validateAdmin(actorId)
                .then(userRepository.findById(userId))
                .switchIfEmpty(Mono.error(new NotFoundException("User not found: " + userId)))
                .flatMap(user -> {
    ...
    @Transactional
    public Mono<Void> demoteToClient(UUID userId, UUID actorId) {
        return validateAdmin(actorId)
                .then(userRepository.findById(userId))
                .switchIfEmpty(Mono.error(new NotFoundException("User not found: " + userId)))
                .flatMap(user -> {
